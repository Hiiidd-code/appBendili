...
<body class="bg-gray-100 text-gray-900 flex flex-col min-h-screen">
    ...
    <nav class="bg-white shadow">
        <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
            <div class="bg-white sticky relative container mx-auto flex">
              <div class="absoute inset-y-0.left-0">
                <a href="{{ route('home') }}" class="font-bold text-lg">
                <img class="object-scale-down h-8" src="{{ asset('images/logo_UT.png') }}">
                </a>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4">
                <a class="" href="{{ route('home') }}" class="text-sm hover:text-blue-600">
                    Beranda
                </a>
